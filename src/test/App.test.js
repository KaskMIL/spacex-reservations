  ...
  it('Check Falcon 1 in the DOM', async () => {
    ...
    await waitFor(() => {
      const waitForDOM = screen.findByText(
        /The Falcon 1 was an expendable launch system privately-developed and manufactured by SpaceX during 2006-2009. On 28 September 2008, Falcon 1 became the first privately-deve liquid-fuel launch vehicle to go into orbit around the Earth./,
      );
