...
describe('Reducer tests', () => {
  test('Reducer return empty state if action is undefined', () => {
    const initial = [{
      dragon_id: '1', dragon_name: 'dragon1', dragon_type: 'type', dragon_description: 'description', dragon_image: 'image', reserved: false,
    }];
  ...
  test('Reserve Action converts to true reserved key', () => {
    ...
    const final = [{
      dragon_id: '1', dragon_name: 'dragon1', dragon_type: 'type', dragon_description: 'description', dragon_image: 'image', reserved: true,
    }];
